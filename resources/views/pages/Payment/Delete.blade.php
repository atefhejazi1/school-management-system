    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('Payment_trans.delete_payment_voucher_title') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Payment_students.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{ trans('Payment_trans.are_you_sure_delete') }}</h5>
