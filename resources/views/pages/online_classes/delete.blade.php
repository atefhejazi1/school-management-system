    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('OnlineClasses_trans.delete_title_prefix') }} {{$online_classe->topic}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('online_classes.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{ trans('OnlineClasses_trans.confirm_delete_warning') }}</h5>
