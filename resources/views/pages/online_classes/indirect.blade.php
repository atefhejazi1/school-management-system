...
@section('css')
@section('title')
    {{ trans('OnlineClasses_trans.add_new_offline_class_title') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
            ...
            <div class="card-body">
                ...
                <form method="post" action="{{ route('indirect.store') }}" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>{{ trans('OnlineClasses_trans.meeting_id_label') }} : <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>{{ trans('OnlineClasses_trans.meeting_password_label') }} : <span class="text-danger">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>{{ trans('OnlineClasses_trans.start_link_label') }} : <span class="text-danger">*</span></label>
                        ...
                        <div class="col-md-8">
                            <div class="form-group">
                                <label>{{ trans('OnlineClasses_trans.join_link_label') }} : <span class="text-danger">*</span></label>
