...
@section('css')
@section('title')
    {{ trans('Quizzes_trans.edit_quiz_title') }} {{$quizz->name}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <div class="col-xs-12">
                        <div class="col-md-12">
                            ...
                            <form action="{{route('Quizzes.update','test')}}" method="post">
                                ...
                                <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{ trans('Quizzes_trans.confirm_submit') }}</button>
                            </form>
                        </div>
                    </div>
                </div>
