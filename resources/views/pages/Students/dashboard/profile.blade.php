...
@section('css')
@section('title')
    {{ trans('Students_trans.Personal_profile') }}
@stop
@endsection
@section('page-header')
<!-- breadcrumb -->
            ...
            <div class="col-lg-4">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <p class="text-muted mb-4">{{ trans('Students_trans.student_role') }}</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-8">
                <div class="card mb-4">
                    <div class="card-body">
                        <form action="{{ route('profile-student.update', $information->id) }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">{{ trans('Students_trans.Username_ar') }}</p>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row">
                                <div class="col-sm-3">
                                    <p class="mb-0">{{ trans('Students_trans.Username_en') }}</p>
                                </div>
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">
