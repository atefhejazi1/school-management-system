    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('Teacher_trans.Delete') }} {{$online_classe->topic}}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('online_zoom_classes.destroy',$online_classe->id)}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{ trans('Teacher_trans.delete_confirm_message') }}</h5>
