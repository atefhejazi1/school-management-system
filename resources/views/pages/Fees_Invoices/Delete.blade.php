    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 style="font-family: 'Cairo', sans-serif;" class="modal-title" id="exampleModalLabel">{{ trans('Fees_trans.delete_invoice_title') }}</h5>
            ...
            <div class="modal-body">
                <form action="{{route('Fees_Invoices.destroy','test')}}" method="post">
                    ...
                    <h5 style="font-family: 'Cairo', sans-serif;">{{ trans('Fees_trans.are_you_sure_delete') }}</h5>
